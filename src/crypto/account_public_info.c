...
static const ChainItem_t g_chainTable[] = {
    ...
    {XPUB_TYPE_IOTA_3,                ED25519,      "iota_3",                   "M/44'/4218'/3'/0'/0'"},
    {XPUB_TYPE_IOTA_4,                ED25519,      "iota_4",                   "M/44'/4218'/4'/0'/0'"},
    {XPUB_TYPE_IOTA_5,                ED25519,      "iota_5",                   "M/44'/4218'/5'/0'/0'"},
    {XPUB_TYPE_IOTA_6,                ED25519,      "iota_6",                   "M/44'/4218'/6'/0'/0'"},
    {XPUB_TYPE_IOTA_7,                ED25519,      "iota_7",                   "M/44'/4218'/7'/0'/0'"},
    {XPUB_TYPE_IOTA_8,                ED25519,      "iota_8",                   "M/44'/4218'/8'/0'/0'"},
    {XPUB_TYPE_IOTA_9,                ED25519,      "iota_9",                   "M/44'/4218'/9'/0'/0'"},
...
uint8_t SpecifiedXPubExist(const char *value)
{
...
uint32_t GetAccountReceiveIndex(const char* chainName)
{
    ...
    if (item == NULL) {
        ...
        if ((!strcmp(chainName, "BTC") || !strcmp(chainName, "ETH"))) {
            cJSON_AddItemToObject(jsonItem, "manage", cJSON_CreateBool(true));
        } else {
            cJSON_AddItemToObject(jsonItem, "manage", cJSON_CreateBool(false));
        }
