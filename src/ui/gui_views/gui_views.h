...
typedef enum {
    ...
    SIG_SHOW_TRANSACTION_LOADING_DELAY,
    SIG_HIDE_TRANSACTION_PARSE_LOADING_DELAY,
    ...
    SIG_QUANTUS_CHECKPHRASE_READY,
    SIG_QUANTUS_TX_CHECKPHRASE_READY,
