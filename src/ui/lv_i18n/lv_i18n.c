...
const static lv_i18n_phrase_t en_singulars[] = {
    ...
    {"boot_update_limit_desc", "Connect the device to USB power or charge to at least 40% to proceed."},
    ...
    {"btc_input_reference", "Input Reference"},
    ...
    {"check_ton_wallet_warning", "Since the current firmware no longer supports native TON seed phrases, your TON-Only wallet data will be deleted. Click Confirm to proceed with the deletion."},
    ...
    {"error_box_firmware_not_detected_desc", "Please ensure that your MicroSD card is formatted in FAT32 and contains the firmware 'forgebox.bin'."},
    ...
    {"firmware_update_sd_desc3", "Transfer the firmware file (forgebox.bin) to your Keystone using a MicroSD card formatted in FAT32."},
...
const static lv_i18n_phrase_t de_singulars[] = {
    ...
    {"check_ton_wallet_warning", "Da die aktuelle Firmware native TON-Seed-Phrasen nicht mehr unterstützt, werden Ihre TON-Only-Wallet-Daten gelöscht. Klicken Sie auf Bestätigen, um mit der Löschung fortzufahren."},
    ...
    {"error_box_firmware_not_detected_desc", "Stellen Sie bitte sicher, dass Ihre MicroSD-Karte im FAT32-Format formatiert ist und die Firmware \"forgebox.bin\" enthält."},
    ...
    {"error_box_low_power_desc", "Das Gerät benötigt mindestens 40% Akkuladung, um den Vorgang fortzusetzen."},
    ...
    {"firmware_update_sd_desc2_link", "https://keyst.one/firmware"},
    {"firmware_update_sd_desc3", "Übertragen Sie die Firmware-Datei (forgebox.bin) mithilfe einer mit FAT32 formatierten MicroSD-Karte auf Ihren Keystone."},
    ...
    {"firmware_update_sd_failed_access_title", "MicroSD fehlt"},
    ...
    {"import_wallet_shamir_backup", "Shamir Backup"},
    {"import_wallet_shamir_backup_desc", "Seed-Shares zum Wiederherstellen."},
    ...
    {"passphrase_warning_text", "Passphrase aktiviert. Ohne Passphrase kein Zugriff."},
    ...
    {"wallet_profile_add_multi_wallet", "MultiSig hinzufügen"},
...
const static lv_i18n_phrase_t es_singulars[] = {
    ...
    {"boot_secure_switch_text_title", "Arranque seguro"},
    {"boot_secure_switch_title", "Arranque seguro"},
    ...
    {"check_ton_wallet_warning", "Dado que el firmware actual ya no admite frases semilla nativas de TON, los datos de su billetera solo para TON se eliminarán. Haga clic en Confirmar para proceder con la eliminación."},
    ...
    {"error_box_firmware_not_detected_desc", "Por favor, asegúrate de que tu tarjeta MicroSD esté formateada en FAT32 y contenga el firmware 'forgebox.bin'."},
    ...
    {"firmware_update_sd_desc2_link", "https://keyst.one/firmware"},
    {"firmware_update_sd_desc3", "Transfiere el archivo de firmware (forgebox.bin) a tu Keystone utilizando una tarjeta MicroSD formateada en FAT32"},
    ...
    {"firmware_update_verify_firmware_qr_link", "KeystoneHQ/keystone3-firmware/docs/verify.md"},
    {"firmware_update_via_sd", "Usar MicroSD"},
    ...
    {"passphrase_access_switch_title", "Acceso con Passphrase"},
...
const static lv_i18n_phrase_t ja_singulars[] = {
    ...
    {"change_entropy_system_desc", "キーストーンSEsからシードフレーズを作成し、真のランダムナンバージェネレータ ーを使用してください."},
    ...
    {"check_ton_wallet_warning", "現在のファームウェアはネイティブTONシードフレーズをサポートしなくなったため、TON専用ウォレットのデータが削除されます。削除を続行するには、確認をクリックしてください。"},
    ...
    {"error_box_firmware_not_detected_desc", "あなたのMicroSDカードがFAT32でフォーマットされ、ファームウェア「forgebox.bin」が含まれていることを確認してください."},
    ...
    {"error_box_low_power_desc", "デバイスはプロセスを続行するために最低40％のバッテリー残量が必要です."},
    ...
    {"firmware_update_sd_desc2_link", "https://keyst.one/firmware"},
    {"firmware_update_sd_desc3", "Keystoneにファームウェアファイル(forgebox.bin)をMicroSDカードに転送し、そのカードをFAT32形式でフォーマットしてください."},
    ...
    {"firmware_update_sd_failed_access_title", "SDカード未検出"},
    ...
    {"multisig_export_to_sdcard_success", "エクスポート完了."},
    ...
    {"wallet_profile_import_multi_wallet", "マルチシグウォレットをインポート"},
...
const static lv_i18n_phrase_t ko_singulars[] = {
    ...
    {"check_ton_wallet_warning", "현재 펌웨어는 더 이상 네이티브 TON 시드 구문을 지원하지 않으므로 TON 전용 지갑 데이터가 삭제됩니다. 삭제를 진행하려면 확인을 클릭하세요."},
...
const static lv_i18n_phrase_t ru_singulars[] = {
    ...
    {"check_ton_wallet_warning", "Поскольку текущая прошивка больше не поддерживает родные фразы восстановления TON, данные вашего кошелька только для TON будут удалены. Нажмите Подтвердить, чтобы продолжить удаление."},
    ...
    {"error_box_firmware_not_detected_desc", "Убедитесь, что на MicroSD загружен файл с прошивкой (forgebox.bin) и карта отформатирована в стандарте FAT32. "},
    ...
    {"firmware_update_sd_desc2_link", "https://keyst.one/firmware"},
    {"firmware_update_sd_desc3", "Перенесите файл с прошивкой (forgebox.bin) на Keystone используя MicroSD карту с форматированием FAT32."},
...
const static lv_i18n_phrase_t zh_cn_singulars[] = {
    ...
    {"check_ton_wallet_warning", "由于当前固件不再支持原生TON助记词，您的TON-Only钱包数据将被删除。点击确认继续删除。"},
    ...
    {"error_box_firmware_not_detected_desc", "请确保您的 microSD 卡为 FAT32 格式,并包含固件\" forgebox.bin\"."},
